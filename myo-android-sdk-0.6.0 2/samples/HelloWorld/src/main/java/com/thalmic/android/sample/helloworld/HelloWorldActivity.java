...
public class HelloWorldActivity extends Activity {
    ...
    public Hub hub;
    public TextView repCountTextView;
        ...
        public void onPose(Myo myo, long timestamp, Pose pose) {
            ...
            switch (pose) {
                ...
                case FINGERS_SPREAD:
                    ...
                    repCountTextView = (TextView) findViewById(R.id.repCount);
                    switchListeners();
                    break;
                /*case THUMB_TO_PINKY:
    ...
    private DeviceListener mListener2 = new AbstractDeviceListener() {
        ...
        public void onPose(Myo myo, long timestamp, Pose pose) {
            ...
            switch (pose) {
                ...
                case FIST:
                    ++repCount;
                    repCountTextView.setText(Integer.toString(repCount));
                    break;
                /*case WAVE_IN:
                    mTextView.setText(getString(R.string.pose_wavein));
                    break;
